...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/abonn/Desktop/Cours_ESIREM/5eme_Annee/interface_systemes_embarques/TP/TP_video_VGA_2019/TP_video_VGA_2019.cache/compile_simlib/riviera"
  fi
